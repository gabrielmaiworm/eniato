                        ...
                        child: Stack(
                          children: [
                            ...
                            if (valueOrDefault(
                              ...
                              AuthUserStreamWidget(
                                child: Image.asset(
                                  'assets/images/atualModerado-removebg-preview.png',
                                  width: MediaQuery.of(context).size.width,
                                  height:
                                      MediaQuery.of(context).size.height * 0.3,
                                  fit: BoxFit.contain,
                            ...
                            if (valueOrDefault(
                              ...
                              AuthUserStreamWidget(
                                child: Image.asset(
                                  'assets/images/atualArrojado-removebg-preview.png',
                                  width: MediaQuery.of(context).size.width,
                                  height:
                                      MediaQuery.of(context).size.height * 0.3,
                                  fit: BoxFit.contain,
                          ...
                          child: Stack(
                            children: [
                              if (valueOrDefault(
                                ...
                                AuthUserStreamWidget(
                                  child: Image.asset(
                                    'assets/images/recomendadoConservador-removebg-preview.png',
                                    width: MediaQuery.of(context).size.width,
                              ...
                              if (valueOrDefault(
                                ...
                                AuthUserStreamWidget(
                                  child: Image.asset(
                                    'assets/images/recomendadoModerado-removebg-preview.png',
                                    width: MediaQuery.of(context).size.width,
                                    height: MediaQuery.of(context).size.height *
                                        0.3,
                                    fit: BoxFit.contain,
                              ...
                              if (valueOrDefault(
                                ...
                                AuthUserStreamWidget(
                                  child: Image.asset(
                                    'assets/images/recomendadoArrojado-removebg-preview.png',
                                    width: MediaQuery.of(context).size.width,
                                    height: MediaQuery.of(context).size.height *
                                        0.3,
                                    fit: BoxFit.contain,
