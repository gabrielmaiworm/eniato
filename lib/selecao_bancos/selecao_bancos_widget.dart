...
import '../cadastro_banco/cadastro_banco_widget.dart';
...
class SelecaoBancosWidget extends StatefulWidget {
  const SelecaoBancosWidget({Key? key}) : super(key: key);

  @override
  _SelecaoBancosWidgetState createState() => _SelecaoBancosWidgetState();
}

class _SelecaoBancosWidgetState extends State<SelecaoBancosWidget> {
                    ...
                    child: InkWell(
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => CadastroBancoWidget(
