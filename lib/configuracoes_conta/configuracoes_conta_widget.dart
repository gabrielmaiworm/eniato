...
import '../poltica_privacidade/poltica_privacidade_widget.dart';
import '../tipos_perfis/tipos_perfis_widget.dart';
...
class ConfiguracoesContaWidget extends StatefulWidget {
  const ConfiguracoesContaWidget({
    Key? key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _ConfiguracoesContaWidgetState createState() =>
      _ConfiguracoesContaWidgetState();
}

class _ConfiguracoesContaWidgetState extends State<ConfiguracoesContaWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final configuracoesContaUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                          ...
                          InkWell(
                            ...
                            child: Material(
                              ...
                              child: Container(
                                ...
                                height: 60,
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context).opcoes,
                                  borderRadius: BorderRadius.circular(8),
                                  border: Border.all(
                                    color: Color(0x00276BB5),
                                    width: 2,
                                  ),
                                ),
                                child: Padding(
                          ...
                          InkWell(
                            onTap: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => TiposPerfisWidget(),
                                ),
                              );
                            },
                            child: Material(
