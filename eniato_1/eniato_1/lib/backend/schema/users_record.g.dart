    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'tipoInvestimento':
          result.tipoInvestimento = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
          break;
...
class _$UsersRecord extends UsersRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is UsersRecord &&
        ...
        tipoInvestimento == other.tipoInvestimento &&
        ffRef == other.ffRef;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UsersRecord')
          ...
          ..add('tipoInvestimento', tipoInvestimento)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String? _tipoInvestimento;
  String? get tipoInvestimento => _$this._tipoInvestimento;
  set tipoInvestimento(String? tipoInvestimento) =>
      _$this._tipoInvestimento = tipoInvestimento;
  ...
  UsersRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _tipoInvestimento = $v.tipoInvestimento;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
